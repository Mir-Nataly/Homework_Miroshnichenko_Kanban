...
import FormChangeNewTask from '../forms/FormChangeTask'
import DeleteRemove from '../../assets/delete_remove_icon_251986.svg'
...
const TaskDetail = (props) => {
	...
	return (
		<>
			<Link to='/' className={css.homeLink}><img src={DeleteRemove}/></Link>
